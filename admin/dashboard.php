...
exigirLogin('admin');
atualizarStatusExtintores($pdo); // Atualiza status automaticamente
...
<head>
    ...
    <title>Dashboard Admin — Sistema de Incêndio Bloco B</title>
...
<div class="wrapper">
    ...
    <main class="conteudo">
        ...
        <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:24px;flex-wrap:wrap;gap:12px">
            ...
            <a href="/bloco_b_fire/admin/extintor_form.php" class="btn-vermelho">
                + Novo extintor
            </a>
        </div>
        ...
        <!-- Grid: próximas inspeções + por pavimento -->
        <div style="display:grid;grid-template-columns:2fr 1fr;gap:20px;align-items:start">
            ...
            <div class="tabela-card">
                <div class="tabela-header">
                    ...
                    <a href="/bloco_b_fire/admin/extintores.php" class="btn-outline">Ver todos</a>
                </div>
                <table>
                    <thead>
                        <tr>
